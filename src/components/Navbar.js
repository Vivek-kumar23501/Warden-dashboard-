    ...
    <>
      ...
      {isMobile && (
        <div className="mobile-topbar d-flex justify-content-between align-items-center px-3 py-2 bg-light">
          <Link to="/" className="navbar-brand text-dark fs-5 m-0">Warden  Dashboard</Link>
          <FaBars
            size={24}
      ...
      >
        <Nav vertical className="p-3">
          <Link to="/" className="navbar-brand text-primary fs-5 m-0"><b>Warden  Dashboard</b></Link>
          <br />
          <NavItem>
            <Link
              to="/"
          ...
          <NavItem>
            <Link
              to="/MessReduction"
              className={`nav-link ${activeLink === '/MessReduction' ? 'active-link' : 'text-dark'}`}
              onClick={() => handleMenuClick('/MessReduction')}
            >
